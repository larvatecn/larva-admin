...
if (!function_exists('amis')) {
    function amis($type = null): \Larva\Admin\Renderers\Component
    {
        $component = \Larva\Admin\Renderers\Component::make();
...
if (!function_exists('amisMake')) {
    function amisMake(): \Larva\Admin\Renderers\Amis
    {
        return \Larva\Admin\Renderers\Amis::make();
    }
}
